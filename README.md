...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sshpubkeys-feedstock/blob/master/LICENSE.txt)

Summary: SSH public key parser

Development: https://github.com/ojarva/python-sshpubkeys
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7291&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sshpubkeys-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sshpubkeys` can be installed with:

```
conda install sshpubkeys
```

It is possible to list all of the versions of `sshpubkeys` available on your platform with:
